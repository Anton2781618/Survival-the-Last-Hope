...
namespace States
{
    public class StateWeaponOff : WeaponState
    {
        ...
        public override void Init()
        {
            ...
            {
                toPosition = stateService.playerModel.PistolHolster;
            }
        }
        ...
        {
            Vector3 positionOffset = stateService.CurrentWeapon ? stateService.CurrentWeapon.GetModel().LerpCurve.Evaluate(lerpRatio) * stateService.CurrentWeapon.GetModel().LerpOffset : Vector3.zero;
